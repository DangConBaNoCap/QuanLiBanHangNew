...
namespace QuanLiBanHang.Data
{
    class HoaDonBanBus
    {
       ...
       public DataTable DanhSachSPMoi(string dk)
        {
           string sql=@"SELECT top 4 SANPHAM.TenSP, SANPHAM.MaSP, SANPHAM.GiaBan, SANPHAM.NhaCC, LOAIHANG.TenLH "+
             "FROM SANPHAM INNER JOIN LOAIHANG ON SANPHAM.MaLH = LOAIHANG.MaLH " +dk;
